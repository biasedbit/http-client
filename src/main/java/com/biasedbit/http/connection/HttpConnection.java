 ...
 * by calling {@link #isAvailable()} prior to {@link #execute(com.biasedbit.http.HttpRequestContext) execute()}.
 * <p/>
 * Example:
 * <pre class="code">
 ...
 * time, both will be able to {@linkplain #execute(com.biasedbit.http.HttpRequestContext) submit requests}, even though
 * the implementation may not accept both (and consequently fail the last one with
 * {@link com.biasedbit.http.future.HttpRequestFuture#EXECUTION_REJECTED}).
 * <p/>
 * Example:
 * <pre class="code">
 ...
 * com.biasedbit.http.future.HttpRequestFuture#EXECUTION_REJECTED}).
 * </div>
 *
...
public interface HttpConnection extends ChannelHandler {
     ...
     * request with the reason {@link com.biasedbit.http.future.HttpRequestFuture#EXECUTION_REJECTED} and return
     ...
     * com.biasedbit.http.future.HttpRequestFuture#setFailure(Throwable) setFailure()} or {@link
     * com.biasedbit.http.future.HttpRequestFuture#setSuccess(Object,
